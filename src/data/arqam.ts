...
export interface Period { n: number; time: string; }
...
export const ArqamData = {
  ...
  periods: [
    { n:1, time:'07:30' }, { n:2, time:'08:15' }, { n:3, time:'09:00' }, { n:4, time:'09:45' },
    { n:5, time:'10:50' }, { n:6, time:'11:35' }, { n:7, time:'12:20' }, { n:8, time:'13:05' },
  ] as Period[],

  days: ['الأحد','الإثنين','الثلاثاء','الأربعاء','الخميس'],

  timetable11A: [
    [ {s:'تجمع الصباح',k:'flex',t:'—'}, {s:'العربية 1',t:'أ. خالد السيابي'}, {s:'الإسلامية 1',t:'أ. أحمد الحارثي',hero:true}, {s:'الكيمياء',t:'أ. طارق المحرزي'}, {s:'الرياضيات البحتة',t:'أ. فيصل الزعابي'}, {s:'الفيزياء',t:'أ. مازن الفارسي'}, {s:'الإنجليزية',t:'أ. يوسف المعمري'}, {s:'العربية 1',t:'أ. خالد السيابي'} ],
    [ {s:'الرياضيات البحتة',t:'أ. فيصل الزعابي',now:true}, {s:'الإسلامية 1',t:'أ. أحمد الحارثي',hero:true,now:true}, {s:'العربية 2',t:'أ. سعيد الهنائي'}, {s:'الأحياء',t:'أ. عبدالعزيز الخليلي'}, {s:'الإنجليزية',t:'أ. يوسف المعمري'}, {s:'الدراسات الاجتماعية',t:'أ. نبيل اللواتي'}, {s:'التوجيه المهني',t:'أ. حميد الشكيلي'}, {s:'مرن',k:'flex',t:'—'} ],
    [ {s:'الإنجليزية',t:'أ. يوسف المعمري'}, {s:'الفيزياء',t:'أ. مازن الفارسي'}, {s:'الأحياء',t:'أ. عبدالعزيز الخليلي'}, {s:'العربية 1',t:'أ. خالد السيابي'}, {s:'الرياضيات البحتة',t:'أ. فيصل الزعابي'}, {s:'الإسلامية 2',t:'أ. أحمد الحارثي'}, {s:'العربية 2',t:'أ. سعيد الهنائي'}, {s:'مرن',k:'flex',t:'—'} ],
    [ {s:'الرياضيات البحتة',t:'أ. فيصل الزعابي'}, {s:'الدراسات الاجتماعية',t:'أ. نبيل اللواتي'}, {s:'الإنجليزية',t:'أ. يوسف المعمري'}, {s:'الإسلامية 1',t:'أ. أحمد الحارثي',hero:true}, {s:'الكيمياء',t:'أ. طارق المحرزي'}, {s:'العربية 2',t:'أ. سعيد الهنائي'}, {s:'الفيزياء',t:'أ. مازن الفارسي'}, {s:'مرن',k:'flex',t:'—'} ],
    [ {s:'العربية 1',t:'أ. خالد السيابي'}, {s:'الرياضيات البحتة',t:'أ. فيصل الزعابي'}, {s:'الكيمياء',t:'أ. طارق المحرزي'}, {s:'الإسلامية 2',t:'أ. أحمد الحارثي'}, {s:'الأحياء',t:'أ. عبدالعزيز الخليلي'}, {s:'الدراسات الاجتماعية',t:'أ. نبيل اللواتي'}, {s:'التوجيه المهني',t:'أ. حميد الشكيلي'}, {s:'مرن',k:'flex',t:'—'} ],
  ] as TimetableCell[][],
