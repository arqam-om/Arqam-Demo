      ...
      <div className="auth-brand">
        <div className="auth-brand-inner">
          ...
          <p style={{margin:0, fontSize:14, color:'var(--text-tertiary)', maxWidth:340, lineHeight:1.8}}>
            تعليم يجمع بين القيم الأصيلة والتقنية الحديثة
          </p>
        </div>
      </div>
      ...
      <div className="auth-form-panel">
        <div className="auth-form-inner">
          <div className="col gap-2 mb-5">
            ...
            <p className="t-body" style={{margin:0, color:'var(--text-secondary)'}}>أهلاً بك في أرقم. سجّل الدخول لمتابعة تعلّمك.</p>
          </div>
...
function SentScreen({ onBack, onOpen }: { onBack: ()=>void; onOpen: ()=>void }) {
  return (
    <div className="auth-page">
      <div className="auth-brand"><div className="auth-brand-inner"><ArqamLogo size={64}/></div></div>
      <div className="auth-form-panel">
